...
const reviews = [
  ...
  },
  {
    ...
    date: "2 months ago",
    rating: 5,
    text: "Our garage conversion turned out amazing. It's now a fully functional studio that we rent out for $2,200/month. Best investment we've made.",
  },
  {
    author: "Robert S.",
    date: "3 months ago",
    ...
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mt-10">
          <a
            href="https://g.page/r/distinctconstructionsolutions/review"
            target="_blank"
