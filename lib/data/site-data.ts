...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  },
  {
    ...
    imageStatus: "ready",
    description:
      "A 3,200 sq ft custom home in Coronado featuring modern California architecture, open living spaces, premium finishes, and strong indoor-outdoor living tailored for comfortable family use.",
  },
  {
    id: "6",
    category: "bathroom",
    ...
    imageStatus: "ready",
    description:
      "A complete bathroom renovation with custom tile work, a walk-in shower, modern vanity, updated fixtures, and a clean contemporary material palette.",
  },
];
