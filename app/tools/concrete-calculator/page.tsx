        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80">
              Estimate costs for driveways, patios, walkways, and slabs. Includes optional retaining wall estimates.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            From driveways and patios to retaining walls and foundations, we handle it all with professional results.
          </p>
          <Link href="/contact">
